...
>
> **Governance**: Architecture, styling, and core rules are enforced via `.agents/rules/` (Antigravity) — see `001-styling.md`, `002-core-invariants.md`, and `003-development-standards.md` (always_on). This document defines *what* to build; those files define *how* it must be built. Do not restate or override them here.
